...
const AMOUNT_FIELDS    = ['amount', 'quantity', 'qty', 'maxQuantity', 'maxMint', 'allowance', 'quantityLimit', 'allocation'];
...
function normalizeEntry(data, walletAddress) {
  ...
  // Allocation field (FCFS proof entries)
  const allocation = raw.allocation !== undefined ? BigInt(raw.allocation) : undefined;
